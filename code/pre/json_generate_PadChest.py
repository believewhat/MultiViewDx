...
def process_directory(base_dir, image_base_dir):
    ...
    with open('PadChest.json', 'w', encoding='utf-8') as json_file:
        json.dump(all_conversations, json_file, indent=4, ensure_ascii=False)

    print(f"Conversations extracted and saved to 'PadChest.json'.")

# Specify base directories and run the process
base_dir = '/mnt/cache_share/MedTrinity-25M/PadChest/instruct'
image_base_dir = '/mnt/cache_share/MedTrinity-25M/PadChest/images'
